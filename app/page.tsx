...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* ── 히어로 ── */}
      <section className="flex items-center justify-center border-b border-gray-200 bg-white sm:min-h-[calc(100vh-72px)] dark:border-gray-800 dark:bg-gray-900">
        <div className="mx-auto flex w-full max-w-[900px] flex-col items-center gap-8 px-5 py-16 md:flex-row md:items-center md:justify-between md:gap-16 md:py-0 md:pb-[5vh]">
